...
| Positional audio and advanced sound instance management                                        | `%SoundAudioStagingSystem.cpp`                                              | `audio`       | [aud::SoundStage](@ref grem::audio::SoundStage), [audio::Listener](@ref grem::audio::Listener) |
...
| Sub-frame input manager output event handling                                                  | `%GameClient.cpp`                                                           | `events`      | [events::EventPump](@ref grem::events::EventPump), [events::InputManager](@ref grem::events::InputManager) |
| Splitscreen input manager setup                                                                | `%GameClient.cpp`                                                           | `events`      | [events::InputManager](@ref grem::events::InputManager) |
